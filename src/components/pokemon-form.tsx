...
const PokemonForm: FunctionComponent<Props> = ({pokemon, isEditForm}) => {
  ...
  /**
   * Le champ picture n'existe que pour l'ajout d'un pokémon
   * SI il y'a pokemon.picture donc on édit si il n'existe pas 
   * on veut donc créer un pokemon.
   */
  const isAddForm = () => {
    return !isEditForm;
  }
                ...
                <div className="form-group">
                  ...
                  {types.map(type => (
                    <div key={type} style={{marginBottom: '10px'}}>
                      <label>
                        <input 
                        id={type} type="checkbox" className="filled-in" 
